...
await mountWorkflow("monitor", "Monitor");
await mountWorkflow("hello", "Hello");
await mountWorkflow("create-workflow", "Create Workflow");
await mountWorkflow("context-engineer", "Context Engineer");
await mountWorkflow("route-task", "Route Task");
await mountWorkflow("create-skill", "Create Skill");
await mountWorkflow("extract-skill", "Extract Skill");
await mountWorkflow("monitor-smithers", "Monitor Smithers");
await mountWorkflow("triage-run", "Triage Run");
await mountWorkflow("context-doctor", "Context Doctor");
await mountWorkflow("backpressure-plan", "Backpressure Plan");
await mountWorkflow("eval-author", "Eval Author");
await mountWorkflow("report-slideshow", "Report Slideshow");
